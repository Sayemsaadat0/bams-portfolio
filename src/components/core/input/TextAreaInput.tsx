...
const textAreaInputVariants = cva('outline-none bg-inherit py-3 px-4 peer h-36 w-full bg-oc-white-50', {
  variants: {
    variant: {
      primaryInput: 'border border-oc-primary-1-300 rounded-[10px]',
      secondaryInput: 'border-b border-b-oc-primary-1-300',
    },
  },
  defaultVariants: {
